export const ValueAssesmentData = [
  ...
  },
  {
    ...
    options: [
      "Flourish autonomously, take full ownership ",
      "Adaptable, embrace opportunities and variety ",
      "Value fairness, seek diverse collaboration",
    ],
  },
  {
    questionNo: 5,
...
export const ValuseAssesmentRating = [
  {
  ...
  {
    value: "Hedonism",
    statement: "Prioritize long-term goals over fun and enjoyment",
  },
  {
    value: "Power",
    statement:
...
export const ClientAssessmentData = [
  {
    ...
    assessmentName: "Leadership Skills Evaluation",
    date: "Jan 25, 2024",
    status: "Not Taken",
  },
  {
    companyName: "Key Venture",
    assessmentName: "Work Values Assessment",
    date: "Jan 25, 2024",
...
export const TalentProfileResultData = {
  ...
  coreValues: [
    { name: "Universalism", x: 10 },
    { name: "Universalism", x: 9 },
    { name: "Universalism", x: 8 },
    { name: "Universalism", x: 7 },
    { name: "Universalism", x: 6 },
  ],
...
export const workValueViewData = {
  ...
  data: [
    ...
    { statement: "Power", rating: 2 },
    { statement: "Security", rating: 1 },
    { statement: "Conformity", rating: 2 },
    { statement: "Tradition", rating: 0 },
    { statement: "Benevolence", rating: 0 },
    { statement: "Universalism", rating: 2 },
  ],
};
...
export const AllJobsData = [
  {
    ...
    jobSubStatus: "Technical Interview Scheduled",
    total: 50,
    new: 5,
    active: 45,
    hired: 0,
  ...
  },
  {
    ...
    hiringManager: "Alex Johnson",
    created: "11/ 07/2024",
    jobStatus: "Screening & Evaluation",
    jobSubStatus: "Technical Interview Scheduled",
    total: 50,
    new: 5,
    active: 45,
  ...
  },
  {
    ...
    hiringManager: "Alex Johnson",
    created: "11/ 07/2024",
    jobStatus: "Hiring Manager Review",
    jobSubStatus: "Technical Interview Scheduled",
    total: 50,
    new: 5,
    active: 45,
  ...
  },
  {
    ...
    hiringManager: "Alex Johnson",
    created: "11/ 07/2024",
    jobStatus: "Closed - Successful",
    jobSubStatus: "Resume Screening Completed",
    total: 50,
    new: 5,
    active: 45,
    hired: 0,
  },
  {
    ...
    created: "11/ 07/2024",
    jobStatus: "Screening & Evaluation",
    jobSubStatus: "Offer Letter Sent",
    total: 50,
    new: 5,
    active: 45,
    hired: 0,
...
export const BehaviouralAttributes = [
  ...
  "Excellent interpersonal skills",
  "Excellent interpersonal skills",
  "Enjoy working in team environments Enjoy working in team environments Enjoy working in team environments Enjoy working in team environments",
  "Strong communication abilities Enjoy working in team environments Enjoy working in team environments ",
  "Strong communication abilities Enjoy working in team environments Enjoy working in team environments ",
  "Collaborative mindset",
  "Strong communication abilities Enjoy working in team environments Enjoy working in team environments ",
  "Strong communication abilities Enjoy working in team environments Enjoy working in team environments ",
...
export const candistaeDetailsDataNew = [
  ...
  //   applicationSubStatus: "Phone Interview",
  //   dtpStatus: "Initiated",
  //   score: "70",
  //   alignmentDate: "2024-07-11",
  //   rank: 1,
  ...
  //   applicationSubStatus: "Technical Interview",
  //   dtpStatus: "In Progress",
  //   score: "85",
  //   alignmentDate: "2024-07-15",
  //   rank: 2,
  ...
  //   applicationSubStatus: "HR Review",
  //   dtpStatus: "Approved",
  //   score: "60",
  //   alignmentDate: "2024-07-11",
  //   rank: 3,
  ...
  //   applicationSubStatus: "Onsite Interview",
  //   dtpStatus: "Rejected",
  //   score: "92",
  //   alignmentDate: "2024-07-20",
  //   rank: 4,
  //   recommended_status: "Recommended",
  ...
  //   applicationStatus: "Rejected",
  //   applicationSubStatus: "Skills Assessment",
  //   dtpStatus: "Rejected",
  //   score: "60",
  //   alignmentDate: "2024-07-11",
  //   rank: 2,
...
export const JobTemplateListViewData = {
  templateName: "Leadership Skills Evaluation",
  tag: "ABCD",
  templateDescription: "ABCD",
  ...
  salary: "$80000 - $90000",
  teamSize: 50,
  teamLocation: "heydrabad",
  workCrossFunality: true,
    ...
    items: [
      {
        ...
        name: "Anna Mathew",
        role: "Senior Backend Developer",
        createdTime: "Jan 25, 2024",
        sub_Status: "Phone call",
        date: "14 April, 24",
        document: "Resume",
        applicationStatus: 70,
        profileStatus: 10,
      },
      {
        id: "task-2",
