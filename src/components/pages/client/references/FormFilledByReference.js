            ...
            <div className="filled-by-reference mt-11">
              ...
              <div className="purpose-content py-8">
                ...
                <p className="pt-2 smallTextGray">
                  ...
                  decisions about the candidate's suitability for the [Position]
                  role at [Company Name]. The purpose of this questionnaire is
                  to assess key behavioral competencies that are essential for
                  success in the role. Your honest and candid responses will
                  allow us to better understand the candidate's strengths and
                  areas for development. Please note that all information
                  provided will be treated with the utmost confidentiality and
                  will only be used for the purpose of evaluating the
                  candidate's fit within our organization. We appreciate your
              ...
              <div className="intruction-content">
                ...
                <p className="pt-2 smallTextGray">
                  Please read each scenario given below and answer according to
                  how much you agree with them. Use the provided options of
