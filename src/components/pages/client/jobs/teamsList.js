...
export const TeamsList = () => {
  ...
  const pageChangeHandle = (pageNO) => {
    ...
    axios
      .get(
        `https://xenflexer.northcentralus.cloudapp.azure.com/xen/getAllTeamTemplate?clientId=${user.userId}&pageNo=${pageNO}&pageSize=5`,
        {
          headers: {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://xenflexer.northcentralus.cloudapp.azure.com/xen/getAllTeamTemplate?clientId=${user.userId}&pageNo=1&pageSize=5`,
        {
          headers: {
            Authorization: `Bearer ${user.accessToken}`,
          },
